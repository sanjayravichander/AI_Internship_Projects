...
import os
# Force PyTorch backend and disable TensorFlow early
...
try:
    ...
    st.error(f"⚠️ Could not import AgenticDocumentQAChatbot: {e}")
    st.info("💡 Make sure all required files are in the Chatbot_AI directory")
    st.stop()
try:
